...
export function PageLoading({
  ...
  return (
    <div className="solid-surface flex min-h-[40vh] flex-col items-center justify-center gap-4 rounded-[2rem] border px-6 py-12 text-center shadow-xl shadow-slate-200/60 dark:shadow-slate-950/40">
